...
use crate::gsp::fw::{
    GspRpcHeader, NV_VGPU_MSG_EVENT_GSP_INIT_DONE, NV_VGPU_MSG_EVENT_GSP_LOCKDOWN_NOTICE,
...
#[repr(transparent)]
#[derive(Debug)]
struct MsgqTxHeader(super::fw::MsgqTxHeader);

unsafe impl AsBytes for MsgqTxHeader {}

impl MsgqTxHeader {
    fn new(msgq_size: u32, rx_hdr_offset: u32) -> Self {
        Self(super::fw::MsgqTxHeader::new(
            msgq_size,
            MSGQ_NUM_PAGES,
            rx_hdr_offset,
        ))
...
#[repr(transparent)]
#[derive(Debug)]
struct MsgqRxHeader(super::fw::MsgqRxHeader);

unsafe impl AsBytes for MsgqRxHeader {}

impl MsgqRxHeader {
    fn new() -> Self {
        Self(super::fw::MsgqRxHeader::new())
    }
